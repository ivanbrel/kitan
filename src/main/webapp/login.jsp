...
<div id="login-holder">
    ...
    <!-- start logo -->
    <%--<div id="logo-login">--%>
        <%--<a href="index.html"><img src="resources/img/shared/logo.png" width="156" height="40" alt="" /></a>--%>
    <%--</div>--%>
    <!-- end logo -->
    ...
    <div id="loginbox">
        ...
        <form method="POST" action="login">
            <div id="login-inner">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th></th>
                        <td valign="top"><input type="checkbox" name="_spring_security_remember_me" class="checkbox-size" id="login-check" /><label for="login-check">Запомнить меня</label></td>
                    </tr>
                    <tr>
                        <th></th>
        ...
        <!--  end login-inner -->
        <div></div>
        <a href="${ctx}/registrationpage" class="forgot-pwd">Забыли пароль ?</a>
    </div>
    <!--  end loginbox -->
