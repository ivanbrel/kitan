                        ...
                        <table  class="table table-striped table-bordered">
                            ...
                            <c:forEach items="${list}" var="list">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value='/product/category/edit/${list.id}'/>" title="Изменить" class="btn btn-default btn-xs">
                                            <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
                                        </a>
                                        <a href="<c:url value='/product/category/delete/${list.id}'/>" title="Удалить" class="btn btn-default btn-xs">
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="${ctx}/product/category/add" method="POST">
