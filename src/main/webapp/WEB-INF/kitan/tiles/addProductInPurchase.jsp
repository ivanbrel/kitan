                                ...
                                <c:forEach items="${productsList}" var="elements" varStatus="">
                                    <tr>
                                        <form:form method="POST" modelAttribute="purchase">
                                            <td style="display: none"><form:input value="${elements}" path="products"/></td>
                                            ...
                                            <td width="10"><input type="submit" value="Добавить в корзину" class="btn btn-success custom-width btn-xs"/></td>
                                        </form:form>
                                    </tr>
                                </c:forEach>
                            </tbody>
