...
<link href="${ctx}/resources/css/404_1.css" media="screen, projection" rel="stylesheet" type="text/css">
<link href="${ctx}/resources/css/404_2.css" media="only screen and (max-device-width: 480px)" rel="stylesheet" type="text/css">
